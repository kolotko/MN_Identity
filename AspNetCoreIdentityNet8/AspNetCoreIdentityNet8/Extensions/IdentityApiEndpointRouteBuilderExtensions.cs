...
using AspNetCoreIdentityNet8.Dtos;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : User, new()
    {
        ...
        accountGroup.MapGet("/info", async Task<Results<Ok<InfoResponseDto>, ValidationProblem, NotFound>>
    ...
    private static async Task<InfoResponseDto> CreateInfoResponseAsync<TUser>(TUser user, UserManager<TUser> userManager)
        where TUser : User
    {
        return new()
        {
